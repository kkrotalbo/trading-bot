...
|---|---|---|
| **LONG** | RSI(14) entre 20 y 35 + EMA10 < EMA55 | RSI ≥ 65, Take Profit 7%, Stop Loss 0.5% |
| **SHORT** | EMA10 cruza hacia abajo EMA55 | RSI < 35, Stop Loss 0.5% |
...
```bash
git clone https://github.com/kkrotalbo/trading-bot.git
cd trading-bot
python3 -m venv venv
...
Las operaciones se registran en la tabla `eth_binance_trading_1h` con los siguientes campos:
